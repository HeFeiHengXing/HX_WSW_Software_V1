...
begin
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、耐青霉素肺炎链球菌株。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、耐碳青霉烯类抗菌药物肠杆菌科细菌。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、耐万古霉素的葡萄球菌菌。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、耐碳青霉烯的铜绿假单胞菌。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、耐碳青霉烯的鲍曼不动杆菌。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、多重耐药铜绿假单胞菌。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、高耐药铜绿假单胞菌。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、泛耐药铜绿假单胞菌。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、多重耐药鲍曼不动杆菌。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、高耐药鲍曼不动杆菌。';
     inc(count);
  end;
  ...
  begin
     if count>0 then
        s:=s+#13#10;
     s:=s+inttostr(count+ReportRemarkNumber)+'、泛耐药鲍曼不动杆菌。';
     inc(count);
  end;
