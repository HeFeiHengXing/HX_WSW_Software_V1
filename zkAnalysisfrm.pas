...
procedure TzkAnalysisForm.chkInputClick(Sender: TObject);
begin
...
begin
  ...
  if bNewPatient then
   hpr:=zHelper.create(js,'ypbasezk',self,bHumanInput,bNoScanInput,bNewPatient,0)
  else
   hpr:=zHelper.create(js,'ypbasezk',self,bHumanInput,bNoScanInput,bNewPatient,dmym.rsbasezk['useid']);
...
procedure TzkAnalysisForm.CheckBox1Click(Sender: TObject);
begin
...
procedure TzkAnalysisForm.chkInputKeyPress(Sender: TObject; var Key: Char);
begin
    if key=#13 then
    begin
...
procedure TzkAnalysisForm.CheckBox1KeyPress(Sender: TObject;
  var Key: Char);
begin
    if key=#13 then
    begin
